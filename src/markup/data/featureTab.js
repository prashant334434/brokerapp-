    ...
    content: (
      <>
        <p className="paragraph-big">
          Bring all creature seas blessed whales were earth wherein evening dry
          one. Morning unto fly midst living so shall fish multiply meat day.
        </p>
        <div className="pattern-image">
          <div className="pattern-image-wrapper">
            <img
              className="drop-shadow-1"
              src={featured_detailed_img_1}
              height="470"
              alt="pattern"
            />
